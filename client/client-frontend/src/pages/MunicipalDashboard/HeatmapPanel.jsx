...
export default function HeatmapPanel() {
  const brgyData = [
    ...
    { name: "Brgy. Alegria", lat: 10.59, lng: 123.02, cases: 5, risk: "Low" },
    {
      name: "Brgy. Blumentritt",
      lat: 10.63,
      lng: 123.05,
      cases: 15,
      risk: "Medium",
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      <h2 className="text-2xl font-bold text-gray-900">
        Municipality Heatmap (Active Cases)
      </h2>
      <p className="text-gray-600 mb-6">
        Live GIS mapping of outbreak clusters across Murcia using OpenStreetMap.
      </p>
