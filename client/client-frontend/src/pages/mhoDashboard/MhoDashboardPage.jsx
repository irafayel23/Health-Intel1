...
export default function MhoDashboardPage() {
  ...
  const navItems = [
    { id: "analytics", label: "Mun. Analytics", icon: BarChart3 },
    { id: "heatmap", label: "Heatmap Cases", icon: Map },
    { id: "predictive", label: "Predictions", icon: BrainCircuit },
